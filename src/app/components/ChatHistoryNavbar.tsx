...
export default function ChatHistoryNavbar({ toggleNavbar, isNavbarOpen }: ChatHistoryNavbarProps) {
  ...
  // TODO: Delete when setChatHistory is used
    ...
    <div className="h-full flex flex-col justify-between">
      <div className="flex flex-col mt-4 w-11/12 m-auto text-sm">
        <div className="flex align-middle justify-between">
          ...
          <div className="flex gap-3">
            <button onClick={() => setIsModelModalOpen(true)} className="text-white hover:opacity-80 p-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 0v3.75m-16.5-3.75v3.75m16.5 0v3.75C20.25 16.153 16.556 18 12 18s-8.25-1.847-8.25-4.125v-3.75m16.5 0c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125" />
              </svg>
            </button>
            <button onClick={() => router.push("/")} className="text-white hover:opacity-80 p-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
      ...
      {isNavbarOpen && (
        <div className="text-stone-300 gap-5 p-5 flex flex-col">
          ...
          <div className="w-full">
            <button onClick={() => router.push("/help")} className="flex items-center gap-2 hover:opacity-80">
